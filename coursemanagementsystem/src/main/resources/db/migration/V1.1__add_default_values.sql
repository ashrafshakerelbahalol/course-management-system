...
VALUES
  ...
  (404, 4, 304),
  (405, 5, 305);
  INSERT INTO Assessment (assessment_id, enrollment_id, score, feedback)
VALUES
  (501, 401, 90, 'Good understanding of concepts'),
  (502, 402, 85, 'Needs improvement in practical skills'),
  (503, 403, 95, 'Excellent performance'),
  (504, 404, 80, 'Satisfactory performance'),
  (505, 405, 92, 'Strong potential in software development');